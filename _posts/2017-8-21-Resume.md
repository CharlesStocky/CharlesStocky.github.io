...
Coupizza <br>
- I'm close to deploying my first website using the MERN stack. Beyond learning how to implement Node/React in a "real-world setting", this project has solidified algorithmic concepts learned from earlier projects as well as intoduced me to DigitalOcean's Droplets as a means of hosting. The website's API code can be found <a href='https://github.com/CharlesStocky/coupizza.git'>here</a>. I plan on writing a more in-depth blog post surrounding the DB API once the website is deployed.
